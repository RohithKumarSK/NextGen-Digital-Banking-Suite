...
public class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3(String formno) {
        ...
        // Create a panel to hold all form components
        JPanel panel = new JPanel();
        panel.setLayout(null);  // keep absolute positioning (like your current code)
        panel.setPreferredSize(new Dimension(850, 1200)); // make it tall enough for scrolling
