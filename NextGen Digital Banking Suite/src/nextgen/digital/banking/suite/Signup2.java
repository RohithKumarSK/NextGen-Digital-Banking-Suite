...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        c1.setBounds(350, 120, 320, 20);
        add(c1);

        l3.setBounds(100, 150, 100, 20);
        add(l3);

        c2.setBounds(350, 150, 320, 20);
        add(c2);

        l4.setBounds(100, 180, 100, 20);
        add(l4);

        c3.setBounds(350, 180, 320, 20);
        add(c3);

        l5.setBounds(100, 210, 150, 20);
        add(l5);

        c4.setBounds(350, 210, 320, 20);
        add(c4);

        l11.setBounds(100, 240, 150, 20);
        add(l11);

        l6.setBounds(100, 280, 150, 20);
        add(l6);

        c5.setBounds(350, 280, 320, 20);
        add(c5);

        l7.setBounds(100, 310, 150, 20);
        add(l7);

        t1.setBounds(350, 310, 320, 20);
        add(t1);

        l8.setBounds(100, 340, 180, 20);
        add(l8);

        t2.setBounds(350, 340, 320, 20);
        add(t2);

        l9.setBounds(100, 370, 150, 20);
        add(l9);

        r1.setBounds(350, 370, 100, 20);
        add(r1);

        r2.setBounds(460, 370, 100, 20);
        add(r2);

        l10.setBounds(100, 400, 180, 20);
        add(l10);

        r3.setBounds(350, 400, 100, 20);
        add(r3);

        r4.setBounds(460, 400, 100, 20);
        add(r4);
